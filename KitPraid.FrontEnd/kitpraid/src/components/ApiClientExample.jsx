...
export const ApiClientExample = () => {
  ...
  const handleFetchUser = async () => {
    try {
      ...
      const data = await apiGet(`/auth/user/${userId}`);
  ...
  return (
    <div style={{ padding: "20px", fontFamily: "Arial" }}>
      ...
      >
        ...
        <ul>
          <li>
            Open DevTools: Press <code>F12</code> or Right-click → Inspect
          </li>
          <li>Go to "Console" tab</li>
          <li>
            You'll see all API calls, responses, and errors logged automatically
          </li>
          <li>
            Look for logs like:
            <ul>
              <li>
                <code>📡 API Call: ...</code> - When request is made
              </li>
              <li>
                <code>📊 API Response: ...</code> - When response is received
              </li>
              <li>
                <code>✅ API Success: ...</code> - On successful response
              </li>
              <li>
                <code>❌ API Error: ...</code> - On error
              </li>
              <li>
                <code>🔑 Token expired or invalid</code> - When token is invalid
              </li>
            </ul>
          </li>
        </ul>
