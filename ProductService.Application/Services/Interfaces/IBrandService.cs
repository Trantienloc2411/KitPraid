...
{
    public Task<OperationResult<PageResult<GetBrandDto>>> GetAllBrandsAsync(PageRequest pageRequest);
    public Task<OperationResult<int>> CountAllBrandsAsync();
    public Task<OperationResult<PageResult<GetBrandItemsDto>>> GetAllItemBrandsAsync(PageRequest pageRequest, Guid brandId);
    public Task<OperationResult<GetBrandDto>> GetBrandAsync(Guid brandId);
